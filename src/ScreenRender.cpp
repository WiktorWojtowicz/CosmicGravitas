...
ScreenRender::ScreenRender(SDL_Renderer* r, std::vector<Planet>* pl) : renderer(r), planets(pl) {}

void ScreenRender::ClearRender() {
...
void ScreenRender::RenderFillCircle(int64_t x, int64_t y, int64_t radius) {
...
bool ScreenRender::OnScreen(Planet* p) {
...
void ScreenRender::RenderPlanet(Planet* p) {
